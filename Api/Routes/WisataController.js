...
router.get("/Type", async (req, res) => {
  try {
    ...
    const data = await tujuanWisataService.getLimitedWisataByTypes(
      types,
      limitPerType
    );
...
router.put(
  ...
  async (req, res) => {
    try {
      ...
      const existingDestination = await tujuanWisataService.getDestinationById(
        id
      );
      ...
      await tujuanWisataService.updateDestination(
        id,
        destinationData,
        imageData
      );
